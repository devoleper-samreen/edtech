            ...
            <div className="relative" ref={profileRef}>
              ...
              >
                ...
                <div className="hidden sm:block">
                  <p className="text-xs font-semibold text-gray-800 text-left">{user?.name || "Student"}</p>
                  <p className="text-[10px] text-gray-500 capitalize">{user?.role || "Student"}</p>
                </div>
              </button>
              ...
              {profileOpen && (
                <div className="absolute top-full right-0 mt-2 w-56 bg-white rounded-lg shadow-xl border border-gray-200 py-2 z-50">
                  <div className="px-4 py-3 border-b border-gray-100">
                    ...
                    <p className="text-xs text-gray-400 mt-1 capitalize">Role: {user?.role || "student"}</p>
                  </div>
                  <button
                    onClick={() => {
                      setProfileOpen(false);
