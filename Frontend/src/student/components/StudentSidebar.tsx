      ...
      >
        ...
        <div className="px-4 py-3 border-b border-slate-700 flex items-center justify-between">
          <Link to="/" className="text-lg font-bold text-white hover:opacity-80 transition-opacity">
            ...
            <span className="text-xs font-normal text-slate-400 ml-1">Student</span>
          </Link>
        ...
        <div className="p-2 border-t border-slate-700">
          <button
            ...
            className="flex items-center gap-3 px-3 py-2.5 w-full rounded-md text-sm text-slate-300 hover:bg-red-500/10 hover:text-red-400 transition-all duration-200"
          >
            <LogOut size={18} />
