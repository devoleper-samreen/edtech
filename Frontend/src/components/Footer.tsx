...
const socialLinks = [
  { Icon: LinkedinIcon, href: "https://www.linkedin.com/company/techfox-edu" },
  { Icon: InstagramIcon, href: "https://www.instagram.com/techfox.co?utm_source=qr&igsh=d2tib2w3bWhzOHVs" },
];
            ...
            <div className="flex items-center gap-4 sm:gap-5 text-white">
              {socialLinks.map((social, index) => (
                <motion.a
                  ...
                  className="hover:text-[#FA8128] transition-colors"
